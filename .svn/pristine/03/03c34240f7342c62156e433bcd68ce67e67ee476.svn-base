...
public class GappEditAdditionalReqController {
	...
	@RequestMapping(value = "/EditAdditionalReq.html", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/EditAdditionalReq.html", method = RequestMethod.POST)
	...
	public String addNumber(@RequestParam int rdid,@RequestParam int sid,@RequestParam int deptID,@RequestParam int AppID,@RequestParam int rid,@RequestParam(required = false) String err,ModelMap model){
		//rdid
		GappAdditionalReqDetails additionalReqDetails=gappApplicationDao.getAddReqDetail(rdid);//TODO
	...
	public String addNumber( @ModelAttribute GappAdditionalReqDetails gappAdditionalReqDetails,
		...
		GappApplication gappApplication= gappApplicationDao.getApplicationByID(Integer.parseInt(AppID));
				...
				//System.out.println("edit number value:"+gappAdditionalReqDetails.getRequiredNumber());
				//System.out.println("edit number value:"+gappAdditionalReqDetails.getId());

				gappAdditionalReqDetails.setId(Integer.parseInt(rdid));
	...
	@RequestMapping(value = "/Edittext.html", method = RequestMethod.GET)
	public String addText(@RequestParam int rdid,@RequestParam int sid,@RequestParam int deptID,@RequestParam int AppID,@RequestParam int rid,@RequestParam(required = false) String err,ModelMap model){
	...
	@RequestMapping(value = "/Edittext.html", method = RequestMethod.POST)
	...
	public String addFile(@RequestParam int rdid,@RequestParam int sid,@RequestParam int deptID,@RequestParam int AppID,@RequestParam int rid,ModelMap model){
	...
	@RequestMapping(value = "/Editfile.html", method = RequestMethod.POST)
	...
	public String DeleteText(@RequestParam int rdid,@RequestParam int sid,@RequestParam int deptID,@RequestParam int AppID,@RequestParam int rid,@RequestParam(required = false) String err,ModelMap model){
		...
		GappAdditionalReqDetails gappAdditionalReqDetails=gappApplicationDao.getAddReqDetail(rdid);
		
		gappApplicationDao.removeAddReqDtails(gappAdditionalReqDetails);
		/*System.out.println("inside text");
		model.put("additionalReqDetails", additionalReqDetails);
